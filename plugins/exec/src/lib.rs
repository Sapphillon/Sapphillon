...
pub fn exec_plugin_function() -> PluginFunction {
    PluginFunction {
        ...
        description: "Executes a command in the default shell.".to_string(),
...
pub fn core_exec_plugin() -> CorePluginFunction {
    CorePluginFunction::new(
        ...
        "Exec".to_string(),
        "Executes a command in the default shell.".to_string(),
        op2_exec(),
...
fn op2_exec(
    ...
    // Exclude permission check during tests to prevent hangs.
    #[cfg(not(test))]
    {
...
fn exec_plugin_permissions() -> Vec<Permission> {
    vec![Permission {
        ...
        permission_type: PermissionType::Command as i32,
...
mod tests {
    ...
    fn test_exec_in_workflow() {
        let code = r#"
            const response = exec("echo hello workflow");
        ...
        let perm = PluginFunctionPermissions {
            ...
            permissions: sapphillon_core::permission::Permissions {
                permissions: vec![Permission {
                    ...
                    permission_type: PermissionType::Command as i32,
                    permission_level: PermissionLevel::Unspecified as i32,
                    resource: vec!["echo hello workflow".to_string()],
                }],
            },
        };
    ...
    fn test_permission_error() {
        let code = r#"
            const response = exec("echo hello permission");
            console.log(response);
        "#;
        ...
        let perm = PluginFunctionPermissions {
            ...
            permissions: sapphillon_core::permission::Permissions {
                permissions: vec![Permission {
                    ...
                    permission_type: PermissionType::Command as i32,
                    permission_level: PermissionLevel::Unspecified as i32,
                    resource: vec!["disallowed command".to_string()],
                }],
            },
        };
        ...
        assert!(actual.contains("PermissionDenied"));
    }

    #[test]
    fn test_exec_failure_in_workflow() {
        let code = r#"
            const response = exec("non_existent_command");
            console.log(response);
        "#;
        ...
        let perm = PluginFunctionPermissions {
            ...
            permissions: sapphillon_core::permission::Permissions {
                permissions: vec![Permission {
                    ...
                    permission_type: PermissionType::Command as i32,
                    permission_level: PermissionLevel::Unspecified as i32,
                    resource: vec!["non_existent_command".to_string()],
                }],
            },
        };
        ...
        assert_eq!(workflow.result.len(), 1);
        let actual = &workflow.result[0].result;
        assert!(actual.contains("Error: Command failed with status"));
    }
}
